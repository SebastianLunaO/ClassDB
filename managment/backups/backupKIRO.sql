...
CREATE TABLE `articulos` (
  ...
  `descripcion` varchar(30) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `precio` decimal(8,2) NOT NULL,
  `stock` smallint DEFAULT NULL,
  `stock_min` smallint DEFAULT NULL,
  `stock_medio` smallint DEFAULT NULL,
  `categoriaID` char(2) COLLATE utf8mb4_unicode_520_ci NOT NULL,
...
CREATE TABLE `categorias` (
  `categoriaID` char(2) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `nombre` varchar(40) COLLATE utf8mb4_unicode_520_ci NOT NULL,
...
CREATE TABLE `clientes` (
  ...
  `domicilio` varchar(40) COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `poblacion` varchar(30) COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `cod_postal` char(5) COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `telefono` varchar(9) COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `empleadoID` smallint unsigned DEFAULT NULL,
  `nacionalidad` varchar(40) COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
...
CREATE TABLE `empleados` (
  ...
  `nombre` varchar(25) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `puesto` varchar(15) COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
...
-- Dump completed on 2025-02-05 19:03:52
